  ...
  return (
    <div className="flex flex-col min-h-full">
      ...
      <div className="flex-1 px-4 py-5 flex flex-col gap-4">
        ...
        <button
          onClick={handleTopup}
          disabled={finalAmount < 100 || finalAmount > 10000 || loading}
          className="w-full bg-gradient-to-r from-green-600 to-emerald-500 text-white font-semibold py-4 rounded-xl shadow disabled:opacity-40 disabled:cursor-not-allowed disabled:grayscale flex items-center justify-center gap-2 active:scale-95 transition-all"
        >
          {loading ? (
